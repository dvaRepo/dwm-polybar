...
static const char col_cyan[]        = "#ba4242";
...
static const Rule rules[] = {
	...
	{ "Microsoft Windows", NULL, NULL,    1 << 6,	    0,           -1 },
...
static const char *win[] = { "windows", NULL };
static const char *office[] = { "onlyoffice-desktopeditors", NULL};
static Key keys[] = {
	/* modifier                     key        function        argument */
	{ 0,             XF86XK_AudioLowerVolume,  spawn,          {.v = downvol } },
	{ 0,             XF86XK_AudioMute,         spawn,          {.v = mutevol } },
	{ 0,             XF86XK_AudioRaiseVolume,  spawn,          {.v = upvol } }, 
	{ ALTMOD,			XK_o,	   spawn,	   {.v = office } }, 
	{ MODKEY,		        XK_w,      spawn,	   {.v = win } },
	{ ALTMOD,			XK_v,	   spawn, 	   {.v = KVM } },		
	{ ALTMOD,			XK_b,	   spawn,	   {.v = Bitwarden } },
	{ ALTMOD,			XK_g,	   spawn,          {.v = Geany } },
	{ ALTMOD,		        XK_f, 	   spawn,          {.v = files } },
	{ ALTMOD,	        	XK_l,      spawn,          {.v = lock } }, 
	{ MODKEY,                       XK_p,      spawn,          {.v = dmenucmd } },
	{ MODKEY,                       XK_Return, spawn,          {.v = termcmd } },
	{ MODKEY,                       XK_b,      togglebar,      {0} },
	{ MODKEY,                       XK_j,      focusstack,     {.i = +1 } },
	{ ALTMOD,			XK_w,	   spawn, 	   {.v = web } },
	...
	{ ALTMOD,                       XK_s,      spawn,          SHCMD("ksnip -r") },
	{ MODKEY|ControlMask,		XK_b,      spawn, 	   SHCMD("wall") },\
	{ControlMask,			XK_space,  spawn,	   SHCMD("ulauncher") },
};
